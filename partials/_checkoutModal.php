...
<div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="checkoutModal">Напишите детали заказа:</h5>
        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="город Бендеры,улица: Фонтанная 33" type="text" required minlength="3" maxlength="500">
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        <b><label for="zipcode">Почтовый код:</label></b>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="checkout" class="btn btn-success">Заказ</button>
                </div>
            </form>
        </div>
        </div>
