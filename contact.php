                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Введите свой Email" required value="<?php echo $email ?>">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                <b><label for="phone">Номер:</label></b>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text" id="basic-addon">+373</span>
                                    </div>
                                    <input type="tel" class="form-control" id="phone" name="phone" aria-describedby="basic-addon" placeholder="Введите свой номер телефона" required pattern="[0-9]{10}" value="<?php echo $phone ?>">
                                </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              <b><label for="orderId">Заказ Id:</label></b>
                              <input class="form-control" type="text" id="orderId" name="orderId" placeholder="Заказ Id" value="0">
                              <small id="orderIdHelp" class="form-text text-muted">Если ваша проблема не связана с заказом(Заказ id = 0).</small>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              <b><label for="password">Пароль</label></b>
                              <input class="form-control" id="password" name="password" placeholder=" Введите пароль" type="password" placeholder="Введите пароль" required data-toggle="password">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Как мы можем вам помочь?"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3"><span> Отправить сейчас <i class="ti-arrow-right"></i></span></button>
                              <button type="button" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span> История <i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3" disabled><span> Отправить сейчас<i class="ti-arrow-right"></i></span></button>
                              <small class="form-text text-muted">Сначала войдите в систему, чтобы связаться с нами.</small>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            <h5 class="text-white font-weight-light mb-3">Адрес</h5>
                            <p class="text-white op-7">' .$address. '</p>
                            <h5 class="text-white font-weight-light mb-3 mt-4">Позвони нам</h5>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="adminReply">Ответ администратора</h5>
            ...
            <div class="modal-body" id="messagebd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    ...
                    if($count==0) {
                      ?><script> document.getElementById("messagebd").innerHTML = '<div class="my-1">вы не получили ни одного сообщения.</div>';</script> <?php
                    }
                ?>
                </tbody>
		          </table>
