...
<body>
    ...
    <div class="container my-3">
        <h2 class="py-2">Результат поиска для <em>"<?php echo $_GET['search']?>"</em> :</h2>
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="viewPizzaList.php?catid=' . $catId . '" class="btn btn-primary">Посмотреть все</a>
                        </div>
                    </div>
                </div>';
            }
        ...
        <?php 
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <h6 style="color: #ff0000">руб '.$pizzaPrice. '/-</h6>
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="btn btn-primary mx-2">Добавить в заказ</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="btn btn-primary mx-2">В корзину</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-primary mx-2" data-toggle="modal" data-target="#loginModal">Добавить в заказ</button>';
                                }
                                echo '</form>
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '"><button class="btn btn-primary">Быстрый просмотр</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
            ...
            if($noResult) {
                echo '<div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1>Your search - <em>"' .$_GET['search']. '"</em> - Нет результата</h1>
                        <p class="lead"> Предложения:<ul>
                            <li>Убедитесь, что все слова написаны правильно.</li>
                            <li>Попробуйте разные ключевые слова.</li>
                            <li>Попробуйте использовать более общие ключевые слова.</li></ul>
                        </p>
                    </div>
                </div> ';
            }
