				...
				<div class="card mb-3">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<option hidden disabled selected value>Нет</option>
                                <?php
							...
							<div class="form-group">
								...
								<small id="Info" class="form-text text-muted mx-3">Обновить фото</small>
							</div>
					</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: rgb(111 202 203);">
								<tr>
									<th class="text-center" style="width:7%;">Категория Id</th>
									<th class="text-center">Img</th>
									<th class="text-center" style="width:58%;">Деталь товара</th>
									<th class="text-center" style="width:18%;">Действие</th>
								</tr>
							</thead>
							<tbody>
                            <?php
                                    ...
                                    echo '<tr>
                                            ...
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													<button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#updateItem' .$pizzaId. '">Изменить</button>
													<form action="partials/_menuManage.php" method="POST">
														<button name="removeItem" class="btn btn-sm btn-danger" style="margin-left:9px;">Удалить</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="updateItem<?php echo $pizzaId; ?>">Позиция Id: <?php echo $pizzaId; ?></h5>
      ...
      <div class="modal-body">
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					<b><label for="image">Фото</label></b>
					...
					<button type="submit" class="btn btn-success my-1" name="updateItemPhoto">Обновить фото</button>
				</div>
		...
		<form action="partials/_menuManage.php" method="post">
			...
			<div class="text-left my-2 row">
				...
				<div class="form-group col-md-6">
					<b><label for="catId">Категория Id</label></b>
