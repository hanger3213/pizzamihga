    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(111 202 203);">
                <h5 class="modal-title" id="orderItem<?php echo $orderid; ?>">Детали заказа (<b>Order Id: <?php echo $orderid; ?></b>)</h5>
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    ...
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$pizzaName. '</h5><span class="text-muted font-weight-normal font-italic d-block">руб' .$pizzaPrice. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
