        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">Lke Pizza</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="index.php?page=menuManage" class="nav__link nav-menuManage">
                      ...
                      <span class="nav__name">Меню</span>
                    </a>
                    <a href="index.php?page=contactManage" class="nav__link nav-contactManage">
                      <i class="fas fa-hands-helping"></i>
                      <span class="nav__name">Контактная Информация</span>
                    </a>
                    ...
                    <a href="index.php?page=siteManage" class="nav__link nav-siteManage">
                      ...
                      <span class="nav__name">Настройки сайта</span>
                    </a>
                </div>
            </div>
