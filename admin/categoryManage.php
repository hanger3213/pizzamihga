                ...
                <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Описание категории:</label>
                            ...
                            <div class="form-group">
								...
								<small id="Info" class="form-text text-muted mx-3">Загрузите фото</small>
							</div>  
                        </div>  
                ...
                <div class="card">
                    ...
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width:58%;">Детали категории</th>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="updateCat<?php echo $catId; ?>">Категория Id: <b><?php echo $catId; ?></b></h5>
      ...
      <div class="modal-body">
        <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<button type="submit" class="btn btn-success my-1" name="updateCatPhoto">Фото</button>
				</div>
        ...
        <form action="partials/_categoryManage.php" method="post">
            ...
            <input type="hidden" id="catId" name="catId" value="<?php echo $catId; ?>">
            <button type="submit" class="btn btn-success" name="updateCategory">Обновлять</button>
        </form>
      </div>
    </div>
  </div>
