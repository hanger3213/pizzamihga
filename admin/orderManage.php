        ...
        <table class="table table-striped table-hover text-center" id="NoOrder">
            ...
            <tbody>
                <?php
                    ...
                    if($counter==0) {
                        ?><script> document.getElementById("NoOrder").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%"> Вы не получили ни одного заказа!	</div>';</script> <?php
                    } 
                ?>
            </tbody>
        </table>
