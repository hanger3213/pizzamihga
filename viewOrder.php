...
<body>
    ...
    <div class="container">
        <div class="table-wrapper" id="empty">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-4">
                        <h2>Order <b>Детали</b></h2>
                    </div>
                    <div class="col-sm-8">						
                        <a href="" class="btn btn-primary"><i class="material-icons">&#xE863;</i> <span>Обновить</span></a>
                        <a href="#" onclick="window.print()" class="btn btn-info"><i class="material-icons">&#xE24D;</i> <span>Печать</span></a>
                    </div>
                </div>
            </div>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Проверьте свой заказ. Вам нужно <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal">Войти</a></strong></center></font>
        </div></div>';
    }
    ?>
