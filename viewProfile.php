        ...
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    ...
                    <form action="partials/_manageProfile.php" method="POST">
                        <small>Удалить фото</small><button type="submit" class="btn btn-primary" name="removeProfilePic" style="font-size: 12px;padding: 3px 8px;border-radius: 9px;">Удалить</button>
                    </form>
                    <form action="partials/_manageProfile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                        <div class="upload-btn-wrapper">
                            <small>ЗАменить фото</small>
                            <button class="btn upload">Пока</button>
                            <input type="file" name="image" id="image" accept="image/*">
                        </div>
                        <button type="submit" name="updateProfilePic" class="btn btn-primary" style="margin-top: -20px;font-size: 15px;padding: 3px 8px;">обновить</button>
                    </form>
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="partials/_logout.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Выйти</button></a></li>
                    </ul>
                </div>
            </div>
            <div class="content-panel mb-3" style="display: flex;justify-content: center;">
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    <h2 class="title text-center">Профиль<span class="pro-label label label-warning"> (<?php echo $userType ?>)</span></h2>
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <div class="form-group col-md-6">
                            <b><label for="firstName">Фамилия</label></b>
                            <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Имя" required value="<?php echo $firstName ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <b><label for="lastName">Имя</label></b>
                            <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Фамилия" required value="<?php echo $lastName ?>">
                        </div>
                        </div>
                        <div class="form-group">
                            <b><label for="email">Email:</label></b>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Введтье свой Email" required value="<?php echo $email ?>">
                        </div>
                        <div class="form-row">
                            <div class="form-group  col-md-6">
                                <b><label for="phone">Моб.номер</label></b>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon">+373</span>
                                    </div>
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="Введите номер телефона" required pattern="[0-9]{10}" maxlength="10" value="<?php echo $phone ?>">
                                </div>
                            </div>
                            <div class="form-group  col-md-6">
                        ...
                        <button type="submit" name="updateProfileDetail" class="btn btn-primary">Обновление </button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <?php
            ...
            echo '<div id="notfound">
                <div class="notfound">
                    ...
                    <h2>404 - Страница не отвечает</h2>
