    ...
    <div class="container my-4" id="cont">
        ...
        echo  '<div class="col-md-4">
            ...
            <div class="col-md-8 my-4">
                <h3>' . $pizzaName . '</h3>
                <h5 style="color: #ff0000">руб'.$pizzaPrice. '/-</h5>
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="btn btn-primary my-2">Добавить в корзину</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="btn btn-primary my-2">Перейти в корзину</button></a>';
                    }
                }
                else{
                    echo '<button class="btn btn-primary my-2" data-toggle="modal" data-target="#loginModal">Добавить в корзину</button>';
                }
                echo '</form>
                <h6 class="my-1"> Смотреть </h6>
                <div class="mx-4">
